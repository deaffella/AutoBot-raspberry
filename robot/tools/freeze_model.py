'''
Usage:
    python3 freeze_model.py --model="mymodel.h5" --output="frozen_model.pb"
...
in_model = os.path.expanduser('./models/pilot_22-10-20_0.h5')
output = os.path.expanduser('./models/frozen_model.pb')
